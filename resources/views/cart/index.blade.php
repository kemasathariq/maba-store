        ...
        @if(!empty($cart))
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-6 text-right">
                    ...
                    <form action="{{ route('cart.checkout') }}" method="POST" class="inline-block">
                        @csrf
                        <button type="submit" class="mt-4 bg-green-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-green-700">
                            Proceed to Checkout
                        </button>
                    </form>
                </div>
